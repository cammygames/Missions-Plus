...
_text = parseText format["<t size='3' color='#ff0000' underline='true'>Missions+</t><hr/><br/><t size='1.25' color='#ffff00'>A Strange Bandit Device has Been Spotted Go investigate It!</t>"];
