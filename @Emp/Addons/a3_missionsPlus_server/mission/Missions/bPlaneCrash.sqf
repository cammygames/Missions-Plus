...
_text = parseText format["<t size='3' color='#ff0000' underline='true'>Missions+</t><hr/><br/><t size='1.25' color='#ffff00'>A Bandit Supply Plane Has Crashed! Go Secure The Loot!</t>"];
